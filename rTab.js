/*  rTab A Simple Web Application Tab Navigation, version 1.0
 *  (c) 2013 rrd
 *
 *  rTab is freely distributable under the terms of an MIT-style license.
 *--------------------------------------------------------------------------*/
rTab = {
...
document.observe('dom:loaded', function(){
	//rTab.init(3);	//show tab #4 on start
	rTab.init();
});